...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/products/{id}/edit-pos', [ProductController::class, 'editPos']);
    Route::post('/products/{id}/update-pos', [ProductController::class, 'updatePos']);
    ...
    Route::get('pos/v2', [SellPosController::class, 'createV2'])->name('pos.create_v2');
    Route::get('pos/v3', [SellPosController::class, 'createV3'])->name('pos.create_v3');
    ...
    Route::post('/labels/queue-print', [LabelsController::class, 'queuePrint']);

    Route::get('/print-station', [\App\Http\Controllers\PrintStationController::class, 'index']);
    Route::get('/print-station/next', [\App\Http\Controllers\PrintStationController::class, 'nextJob']);
    Route::post('/print-station/jobs/{id}/done', [\App\Http\Controllers\PrintStationController::class, 'markDone']);
    Route::post('/print-station/clear', [\App\Http\Controllers\PrintStationController::class, 'clearQueue']);
