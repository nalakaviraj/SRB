...
@if (
    $request->segment(1) == 'pos' &&
        ($request->segment(2) == 'create' || $request->segment(2) == 'v2' || $request->segment(2) == 'v3' || $request->segment(3) == 'edit' || $request->segment(2) == 'payment'))
    @php
        $pos_layout = true;
    @endphp
@else
...
<body
    class="tw-font-sans tw-antialiased tw-text-gray-900 tw-bg-gray-100 @if ($pos_layout) hold-transition lockscreen @else hold-transition skin-@if (!empty(session('business.theme_color'))){{ session('business.theme_color') }}@else{{ 'blue-light' }} @endif sidebar-mini @endif @if ($request->segment(1) == 'pos' && $request->segment(2) == 'v2') pos-v2-layout @elseif ($request->segment(1) == 'pos' && $request->segment(2) == 'v3') pos-v3-layout @endif" >
