...
return [
    ...
    */
    ...
    'qz_label_printer_name' => env('QZ_LABEL_PRINTER_NAME', 'label'),
    'qz_receipt_printer_name' => env('QZ_RECEIPT_PRINTER_NAME', 'receipt'),
    'qz_label_gap_mm' => env('QZ_LABEL_GAP_MM', 3),
    'qz_label_dpi' => env('QZ_LABEL_DPI', 203),
];
